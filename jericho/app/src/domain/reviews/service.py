...
def upsert_review(
    ...
    comparison_reviews = utils.get_comparison_reviews(session, review.user_id, comparison)
    ...
    if comparison_reviews.equal_to:
        review = utils.merge_equal_to_review(review, comparison_reviews.equal_to)
