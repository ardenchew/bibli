...
from src.domain.collections import service, schemas
...
@router.get("/collection/{collection_id}", response_model=schemas.CollectionRead)
...
@router.post("/collection_book_link", response_model=schemas.CollectionBookLink)
