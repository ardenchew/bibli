...
class GoogleBooksAPI:
    ...
    def get_book_by_id(self, id: str) -> Book:
        """Retrieves a book by the google identifier.

        :param id: google volume id
        :type id: str
        :return: A Book Object
        :rtype: Book
        """
        response = self._rest_adapter.get(
            endpoint=f"volumes/{id}",
        )
        return Book.from_google_books_api_response_book_item(response.data)
